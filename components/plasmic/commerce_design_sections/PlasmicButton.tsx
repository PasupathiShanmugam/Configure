...
import sty from "./PlasmicButton.module.css"; // plasmic-import: DXnV3iG3Ncth/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__uob23, {
          [sty.freeBoxcolor_neutral__uob230K88Q]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__uob23A6EWgRYx0N]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__uob23VrER]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__uob23DpcHz]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__uob23KkDT]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__uob23C2Yy2]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__uob23Gmkl5]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__uob23RYx0N]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__s2Qx5, {
            [sty.freeBoxcolor_neutral__s2Qx50K88Q]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__s2Qx50K88QQYlN9]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__s2Qx5Ifo4]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__s2Qx5DpcHz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__s2Qx5C2Yy2]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__s2Qx5Gmkl5]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__s2Qx5RYx0N]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___5Mjq1)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__m96La, {
            [sty.freeBoxiconEnd__m96LaFnubZ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__m96LaDpcHz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__m96LaC2Yy2]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__m96Lagmkl5]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__rsFhh)}
                role={"img"}
              />
            ),
